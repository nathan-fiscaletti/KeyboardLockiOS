#
# Be sure to run `pod lib lint KeyboardLock.podspec' to ensure this is a
...
Lock any view to the keyboard. Works best when you have a single container view with everything else inside of it.
  ...
  s.source           = { :git => 'https://github.com/nathan-fiscaletti/KeyboardLock.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'KeyboardLock' => ['KeyboardLock/Assets/*.png']
  # }
